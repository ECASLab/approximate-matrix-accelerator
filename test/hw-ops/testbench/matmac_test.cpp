...
int main(int argc, char **argv) {
  ...
  ama::sw::matmac<ExactType, kRows, kCols>(in_mat_a, in_mat_b, in_mat_c,
                                           sw_result);
  matmac_top_accel(in_mat_a, in_mat_b, in_mat_c, hw_result);

<<<<<<< 400c837e581e0c95637bb1bce9bc6fbcc95a0eb6
...
=======
  ...
  std::cout << "MaxErrorTh: " << 0 << std::endl;
  ...
  return err_cnt;
#endif
>>>>>>> Modify the testbenches to comply with the building system
}
